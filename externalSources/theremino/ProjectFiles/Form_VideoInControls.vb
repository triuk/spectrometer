...
Public Class Form_VideoInControls
    ...
    ' TODO ---------- TrackBar WHEEL
    ' ------------------------------------------------------------------
    '  TRACK-BAR WHEEL correction from step=3 to step=1
    '  Not working when TrackBar is at Minimum and Maximum values
    ' ------------------------------------------------------------------
    Private Sub TrackBars_MouseWheel(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles TrackBar_Exposure.MouseWheel, _
                                                                                                                      TrackBar_Gain.MouseWheel, _
                                                                                                                      TrackBar_Brightness.MouseWheel, _
                                                                                                                      TrackBar_Contrast.MouseWheel, _
                                                                                                                      TrackBar_Gamma.MouseWheel, _
                                                                                                                      TrackBar_BackLight.MouseWheel, _
                                                                                                                      TrackBar_Saturation.MouseWheel, _
                                                                                                                      TrackBar_WhiteBalance.MouseWheel, _
                                                                                                                      TrackBar_Hue.MouseWheel, _
                                                                                                                      TrackBar_ColorEnable.MouseWheel, _
                                                                                                                      TrackBar_Zoom.MouseWheel, _
                                                                                                                      TrackBar_Pan.MouseWheel, _
                                                                                                                      TrackBar_Tilt.MouseWheel, _
                                                                                                                      TrackBar_Sharpness.MouseWheel, _
                                                                                                                      TrackBar_Focus.MouseWheel
        Dim trackBar As TrackBar = DirectCast(sender, TrackBar)
        Dim newvalue As Int32 = trackBar.Value
        If e.Delta > 0 Then
            newvalue -= 2
        Else
            newvalue += 2
    ...
    Friend Sub Capture_GetVideoParams()
        ...
        ' ------------------------------------------------------ test 
        '
        'Debug.Print(t.GetTimeMillisec.ToString + " ms")
